...
ปล. หน้า multi model เข้าไปอาจจะใช้เวลารอนานระดับนึงเพื่อเริ่มใช้งาน ไม่ต้องห่วงนะคะ เว็บไม่ได้ค้าง
...
url_blog = "https://medium.com/@madness_/manga-recommendation-%EF%B8%8F-a8147d933c51 "
...
url_ig = "https://www.instagram.com/jjentaa/"
st.markdown("My ig [www.instagram.com/jjentaa/](%s)" % url_ig)
